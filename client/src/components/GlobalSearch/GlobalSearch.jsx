  ...
  return (
    <>
      <button
        ...
        onClick={openSearch}
      >
        <span className="global-search-button-text">Search our library...</span>
      ...
      >
        <h2 className="global-search-title">
          Welcome to Wizard's Castle library
        </h2>
        <p className="global-search-intro-text">
          Our librarians can help you to find all kinds of ancient knowledge,
          about spells, monsters, and so much more... <br /> Just tell us what
          you need !
        </p>
        <section className="search-decoration">
          <form
            className="main-search-container global-search-container"
          ...
          >
            ...
            <button className="search-icon-button" type="submit">
              <span className="global-search-button-text">Search</span>
